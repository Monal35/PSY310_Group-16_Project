...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Diya\\Desktop\\project_revised_lastrun.py',
...
instructions = visual.TextStim(win=win, name='instructions',
    text="You will see numbers and words from 1 to 20. You will also see simple addition and subtraction in the form of numbers and words. \n\nYou need to choose whether the response should be odd or even. \nIf odd, press 'o' key \nIf even, press 'e' key\n\nPress space bar to continue",
    font='Open Sans',
...
Stimuli = visual.TextStim(win=win, name='Stimuli',
    ...
    color=[-1.0000, -1.0000, 0.0902], colorSpace='rgb', opacity=1.0, 
    languageStyle='LTR',
    depth=-1.0);
...
startComponents = [instructions, key_resp_2]
...
trials = data.TrialHandler(nReps=1.0, method='random', 
    ...
    trialList=data.importConditions('Project conditions 1.xlsx'),
...
for thisTrial in trials:
    ...
    routineForceEnded = False
    # update component parameters for each repeat
    Stimuli.setText(number)
    key_resp.keys = []
    key_resp.rt = []
    _key_resp_allKeys = []
    # keep track of which components have finished
    trialComponents = [fixation, Stimuli, key_resp]
    ...
    while continueRoutine:
        ...
        if key_resp.status == STARTED and not waitOnFlip:
            theseKeys = key_resp.getKeys(keyList=['o','e'], waitRelease=False)
...
trials_2 = data.TrialHandler(nReps=1.0, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('Project conditions 2.xlsx'),
